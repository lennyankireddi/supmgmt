...
function GetSpendPieColor(num) {
    switch(num) {
        case 0: return "#6c5b7f";
        case 1: return "#e9e1df";
    }
}

function GetSupRevColor(num) {
    switch(num) {
        case 0: return "#ef737d";
        case 1: return "#e9e1df";
    }
}
...
function GetQuarterColor(num) {
    switch(num) {
        case 0: return "#f8b28e";
        case 1: return "#ef737d";
        case 2: return "#c16b86";
        case 3: return "#6c5b7f";
    }
}
...
function GetHealthDisplay(health) {
    if (!health) {
        return "<img src='../SiteAssets/images/frown_off.png' class='health-indicator'>" +
                "<img src='../SiteAssets/images/meh_off.png' class='health-indicator'>" +
                "<img src='../SiteAssets/images/smile_off.png' class='health-indicator'>";
    }
    switch(health.toLowerCase()) {
        case "poor": return "<img src='../SiteAssets/images/frown_on.png' class='health-indicator'>" +
                            "<img src='../SiteAssets/images/meh_off.png' class='health-indicator'>" +
                            "<img src='../SiteAssets/images/smile_off.png' class='health-indicator'>";
        case "good": return "<img src='../SiteAssets/images/frown_off.png' class='health-indicator'>" +
                            "<img src='../SiteAssets/images/meh_on.png' class='health-indicator'>" +
                            "<img src='../SiteAssets/images/smile_off.png' class='health-indicator'>";
        case "excellent": return "<img src='../SiteAssets/images/frown_off.png' class='health-indicator'>" +
                            "<img src='../SiteAssets/images/meh_off.png' class='health-indicator'>" +
                            "<img src='../SiteAssets/images/smile_on.png' class='health-indicator'>";
        default: return "<img src='../SiteAssets/images/frown_off.png' class='health-indicator'>" +
                        "<img src='../SiteAssets/images/meh_off.png' class='health-indicator'>" +
                        "<img src='../SiteAssets/images/smile_off.png' class='health-indicator'>";
    }
}
...
function GetSentiment(health) {
    if (!health) {
        return "<img src='../SiteAssets/images/frownoff.png' class='sentiment-icon'>" +
                    "<img src='../SiteAssets/images/mehoff.png' class='sentiment-icon'>" +
                    "<img src='../SiteAssets/images/smileoff.png' class='sentiment-icon'>";
    }
    switch(health.toLowerCase()) {
        case "excellent": return "<img src='../SiteAssets/images/frownoff.png' class='sentiment-icon'>" +
                            "<img src='../SiteAssets/images/mehoff.png' class='sentiment-icon'>" +
                            "<img src='../SiteAssets/images/smileon.png' class='sentiment-icon'>";
        case "good": return "<img src='../SiteAssets/images/frownoff.png' class='sentiment-icon'>" +
                            "<img src='../SiteAssets/images/mehon.png' class='sentiment-icon'>" +
                            "<img src='../SiteAssets/images/smileoff.png' class='sentiment-icon'>";
        case "poor": return "<img src='../SiteAssets/images/frownon.png' class='sentiment-icon'>" +
                            "<img src='../SiteAssets/images/mehoff.png' class='sentiment-icon'>" +
                            "<img src='../SiteAssets/images/smileoff.png' class='sentiment-icon'>";
        default: return "<img src='../SiteAssets/images/frownoff.png' class='sentiment-icon'>" +
                            "<img src='../SiteAssets/images/mehoff.png' class='sentiment-icon'>" +
                            "<img src='../SiteAssets/images/smileoff.png' class='sentiment-icon'>";
    }
}
